...
// Services
const { createStudent } = require('../sevices/StudentService');
const { createTeacher } = require('../sevices/TeacherService');
const { 
  register, 
  login, 
...
const { findByEmail } = require('../sevices/UserService');
const sendMail = require('../sevices/nodemailer');
...
exports.createUser = async (req, res) => {
  try {
    ...
    await createRoleForUser(data.dataValues.role, data.dataValues);
